...
class AccntService {
			...
			throws IllegalAccessException 
	{
		...
		if(updatePwdCount <= 2)
		{
		 ...
		 System.out.println("password updated "+updatePwdCount+" times");
		}
		else
		{
		  IllegalAccessException ia = new IllegalAccessException("Account locked due to multiple pwd change attempts");
		  throw ia;
		}
	}
